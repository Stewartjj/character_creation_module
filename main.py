...
def attack(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за наносимый урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за блокировку урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за спец.умения."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} ничего не применял')


def start_training(char_name: str, char_class: str) -> str:
    """Эта функция отвечает за страт тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Эта функция отвечает за выбор персонажа."""
    approve_choice: str = ''
    char_class: str = ''
